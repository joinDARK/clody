...
type Record struct {
	...
	Cells     []*cell.Cell      `gorm:"foreignKey:RecordID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"cells,omitempty"`
}
...
type RecordRelation struct {
	...
	Field        *field.Field  `gorm:"foreignKey:FieldID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"field,omitempty"`
